    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(choices=[('g', 'gram'), ('tbsp', 'tablespoon'), ('tsp', 'teaspoon'), ('l', 'liter'), ('ea', 'each'), ('cup', 'cup'), ('oz', 'ounces'), ('lbs', 'pound'), ('', '')], default='', max_length=10, verbose_name='Unit of Measure')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(default='', max_length=500, verbose_name='Item Description')),
            ],
            options={
                'ordering': ['name'],
            },
